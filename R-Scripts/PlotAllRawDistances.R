...
# Given a set of boxplots providing a graphical view of
# the hamming distance of values generated by the Alternative models,
# with respect to the Null model, when considering different values of k and
# different types of AF measures
