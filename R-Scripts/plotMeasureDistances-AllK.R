...
selectedMeasure <- 'canberra'

dff <- filter(df, df$len == 5000000 & df$Measure == selectedMeasure) # solo una misura per tutti i k
...
outfname <- sprintf("%s-AllK.png", selectedMeasure)
